...
if __name__ == "__main__":
    ...
    print("=" * 66)
    print()
    print("β_critical trend (extrapolate to ML-DSA-65):")
    ...
    print("  n=256 → β≈425  dim=2049 (NIST claim, infeasible)")
    print()
    print("Result: β grows exponentially with n.")
    print("Gap: n=256 needs β≈425, best hardware achieves β≈50 → ML-DSA-65 holds.")
